...
def word_with_most_repeats(sentence)
  ...
  sentence.split(" ").each do |word|
    current_repeats = word_repeats(word)
...
def word_repeats(word)
  repeats = Set.new()
  no_repeats = Set.new()

  word.each_char do |char|
    if no_repeats.include?(char)
      repeats.add(char)
      no_repeats.delete(char)
    elsif !repeats.include?(char)
      no_repeats.add(char)
    end
  end
